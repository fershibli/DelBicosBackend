 ...
 */
router.get("/user/:id", appointment_controller_1.getAllAppointments);
/**
 * @swagger
 ...
 */
router.post("/:id/review", auth_middleware_1.default, appointment_controller_1.reviewAppointment);
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get("/:id/receipt", auth_middleware_1.default, appointment_controller_1.getAppointmentInvoice);
