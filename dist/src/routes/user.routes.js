 ...
 */
router.post("/change-password", auth_middleware_1.default, user_controller_1.changePassword);
router.get("/me", auth_middleware_1.default, user_controller_1.getUserByToken);
router.put("/me", auth_middleware_1.default, user_controller_1.updateUserProfile);
/**
 * @swagger
 * /user/{id}:
 *   get:
 ...
 */
router.get("/:id", auth_middleware_1.default, user_controller_1.getUserById);
