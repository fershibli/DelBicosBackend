    ...
    if (!professional || !client || !service) {
        ...
        if (professionalUser) {
            await NotificationModel.create({
                ...
                message: `Você recebeu um novo agendamento de ${clientUser?.name || 'Cliente Desconhecido'} para o serviço '${service.title}' no dia ${appointmentDate} às ${appointmentTime}. Status: Pendente de Confirmação.`,
