...
export const createProfessionalGalleryImage = async (req: Request, res: Response) => {
  try {
...
export const getAllProfessionalGalleryImages = async (req: Request, res: Response) => {
  try {
...
export const getByIdProfessionalGalleryImage = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const updateProfessionalGalleryImage = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const deleteProfessionalGalleryImage = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const image = await ProfessionalGalleryModel.findByPk(id);
    if (!image) return res.status(404).json({ error: "Imagem não encontrada" });
